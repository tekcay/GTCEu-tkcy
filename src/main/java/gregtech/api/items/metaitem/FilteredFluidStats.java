...
public class FilteredFluidStats implements IItemComponent, IItemCapabilityProvider {
    ...
    public FilteredFluidStats(int capacity, int maxFluidTemperature, boolean gasProof, boolean acidProof,
        ...
        this(capacity, allowPartialFill,
                new PropertyFluidFilter(maxFluidTemperature, gasProof, acidProof, cryoProof, plasmaProof, false, false));
    }

    public FilteredFluidStats(int capacity, int maxFluidTemperature, boolean gasProof, boolean acidProof,
                              boolean cryoProof, boolean plasmaProof, boolean allowPartialFill, boolean baseProof, boolean fluorideProof) {
        this(capacity, allowPartialFill,
                new PropertyFluidFilter(maxFluidTemperature, gasProof, acidProof, cryoProof, plasmaProof, baseProof, fluorideProof));
    }
