...
public class OrganicChemistryMaterials {
    ...
    public static void register() {
        ...
        Methane = new Material.Builder(1018, gregtechId("methane"))
                ...
                .physicalProperties(new PhysicalProperties.Builder().mp(91).bp(112).flameTemperature(2173).autoIgnitionTemperature(810))
                .color(0xFF0078)
        ...
        Propane = new Material.Builder(1027, gregtechId("propane"))
                .gas()
                .physicalProperties(new PhysicalProperties.Builder().mp(86).bp(231).autoIgnitionTemperature(743).flameTemperature(2243))
                .color(0xFAE250)
                .flags(DISABLE_DECOMPOSITION)
        ...
        Propene = new Material.Builder(1028, gregtechId("propene"))
                .gas()
                .physicalProperties(new PhysicalProperties.Builder().bp(223).mp(88).flameTemperature(2223).autoIgnitionTemperature(728))
                .color(0xFFDD55)
                .flags(DISABLE_DECOMPOSITION)
        ...
        Ethane = new Material.Builder(1029, gregtechId("ethane"))
                .gas()
                .physicalProperties(new PhysicalProperties.Builder().mp(90).bp(185).autoIgnitionTemperature(745).flameTemperature(2235))
                .color(0xC8C8FF)
                .flags(DISABLE_DECOMPOSITION)
        ...
        Butene = new Material.Builder(1030, gregtechId("butene"))
                .gas()
                .physicalProperties(new PhysicalProperties.Builder().flameTemperature(2200).autoIgnitionTemperature(658).bp(267).mp(88))
                .color(0xCF5005)
                .flags(DISABLE_DECOMPOSITION)
        ...
        Butane = new Material.Builder(1031, gregtechId("butane"))
                .gas()
                .physicalProperties(new PhysicalProperties.Builder().mp(136).bp(273).autoIgnitionTemperature(678).flameTemperature(2200))
                .color(0xB6371E)
                .flags(DISABLE_DECOMPOSITION)
        ...
        Dimethylamine = new Material.Builder(1037, gregtechId("dimethylamine"))
                .gas()
                .physicalProperties(new PhysicalProperties.Builder().autoIgnitionTemperature(674).mp(180).bp(282).flameTemperature(2500))
                .color(0x554469)
                .flags(DISABLE_DECOMPOSITION)
        ...
        Butadiene = new Material.Builder(1042, gregtechId("butadiene"))
                .gas()
                .physicalProperties(new PhysicalProperties.Builder().mp(164).bp(269).autoIgnitionTemperature(687).flameTemperature(2223))
                .color(0xB55A10)
                .flags(DISABLE_DECOMPOSITION)
        ...
        AceticAcid = new Material.Builder(1044, gregtechId("acetic_acid"))
                ...
                .physicalProperties(new PhysicalProperties.Builder().mp(290).bp(391).autoIgnitionTemperature(700).flameTemperature(2123))
                .color(0xC8B4A0)
        ...
        VinylChloride = new Material.Builder(1047, gregtechId("vinyl_chloride"))
                .gas()
                .physicalProperties(new PhysicalProperties.Builder().bp(260).mp(119).autoIgnitionTemperature(745).flameTemperature(2180))
                .color(0xE1F0F0)
                .flags(DISABLE_DECOMPOSITION)
                .components(Carbon, 2, Hydrogen, 3, Chlorine, 1)
                .build();
        ...
        Ethylene = new Material.Builder(1048, gregtechId("ethylene"))
                .gas()
                .physicalProperties(new PhysicalProperties.Builder().mp(104).bp(170).autoIgnitionTemperature(816).flameTemperature(2250))
                .color(0xE1E1E1)
                .flags(DISABLE_DECOMPOSITION)
                .components(Carbon, 2, Hydrogen, 4)
                .build();
